<!DOCTYPE html>
<meta charset="utf-8">
<title>Web Speech Chatbot Demo</title>
<style>
  * {
...
<script type="text/javascript">
  ...
  u.text = 'Hello, my name is Greg the Chatbot';
  u.lang = 'en-US';
  u.rate = 1.2;
...
// Wait function to allow our pieces to get here prior to starting
	...
	function hello(){
		chatter[chatpoint] = "> Hello, I'm your chatbot."; 
		chatpoint = 1;
		return write();
	}
	function start(){
...
// And to give the illusion that some thinking is going on
	...
	function think(){
		document.Eliza.input.value = final_transcript;        
...
<table cellspacing="0" cellpadding="2" border="0" align="center" class="neurotoy">
	<tr><th bgcolor=#000000 align="left">
  	...
  	<tr><td bgcolor=#0097FF>
    	<form name="Eliza" onChange="return dialog();">
		...
		<center><button onclick="return dialog()">Click to Answer</button></center>
		</form>
